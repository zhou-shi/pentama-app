...
// Definisikan tipe untuk body request agar tidak menggunakan 'any'
interface RequestBody {
  action: string;
  payload: Record<string, any>; // Gunakan Record<string, any> untuk payload yang dinamis
}
...
        const updateData: Record<string, any> = { stage, updatedAt: new Date().toISOString() };
